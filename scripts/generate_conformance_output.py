"""Generate expected conformance output by running VQIEngine on all conformance files.
...
def main():
    ...
    checkpoint_path = os.path.join(conf_dir, "_checkpoint.json")

    output_csv = os.path.join(conf_dir, "conformance_expected_output_v1.0.csv")
    output_features_csv = os.path.join(conf_dir, "conformance_expected_output_v1.0_features.csv")
