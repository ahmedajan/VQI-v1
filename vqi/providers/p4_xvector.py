"""P4: x-vector speaker embedding provider (512-dim).

Uses SpeechBrain's pretrained x-vector model trained on VoxCeleb.
Architecture: Classical TDNN.
"""
...
class P4_XVECTOR(SpeakerProvider):
    ...
    def extract_embedding(
        ...
        with torch.no_grad():
            emb = self._model.encode_batch(waveform)  # (1, 1, 512)
